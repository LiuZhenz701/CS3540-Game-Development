...
namespace TPC
{
    public class MiaInputHandler : MonoBehaviour
    {
        ...
        void Update()
        {
            miaController.hasPunchInput = Input.GetMouseButtonDown(0);
            miaController.hasKickInput = Input.GetMouseButtonDown(1);
        ...
        private void HandleRun(float vertical)
        {
